...
if(isset($_POST['submit'])){
    ...
    if(empty($pn) || empty($topic_id) || empty($date) || empty($file)){
        ...
        $sql= " INSERT INTO papers(Name, topic_id, file, date_of_upload, category, depositor, review) VALUES ('$_POST[pn]', '$_POST[topid]','{$_FILES['fupload']['name']}', '$_POST[date]', '$_POST[cat]', '$_POST[insert]', '$_POST[review]')";
