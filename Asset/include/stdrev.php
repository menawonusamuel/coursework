...
<?php include_once("heading.php");?>
    ...
    <li><a href="studprof.php?stp=4">Go back</a></li>
...
$sql="Select * from papers where file='$_GET[rev]'";
...
# code...
echo "Reviews for \"<strong>" . $_GET['rev'] . "</strong>\" here";


$sq="Select * from reviews r LEFT JOIN papers p ON (r.rpid=p.rpid) where p.file='$_GET[rev]' Order by r.review_id DESC";
