            ...
            <aside id="sidebar">
                <div class="dark">
                    ...
                    <form action="rsrch1.php" enctype="multipart/form-data" method="post">
                        ...
                        <input type="text" name="data" value=<?php   echo date("Y/m/d");?> readonly="true" />
                        <input type="text" name="inset" value="Admin" readonly="true" /><br />
                        <input type="hidden" name="cat" value="Admin" /><br />
