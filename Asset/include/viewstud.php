...
<div style=overflow-x:auto;>
 <table >
 	<tr><b><Th>Id<Th>Firstname</Th><Th>Lastname</Th><Th>Address</Th><Th>Postcode</Th><Th>Email</Th><Th>Username</Th><Th>Password</Th><Th>Image</Th></b></tr>";
    while ($rows = mysqli_fetch_array($query)){

        print "<tr><td>" . $rows[0]. "</td>". "<td>" . $rows[1] . "</td>" . "<td>" .$rows[2] ."</td>" ."<td>" .$rows[3]."</td>" ."<td>". $rows[4]."</td>" ."<td>" . $rows[5] ."</td>" ."<td>" . $rows[6] . "</td><td>". $rows[7] ."</td>"."<td>" ."<a href=profile/{$rows['Photo']}><img src=profile/{$rows['Photo']} alt=Person width=96 height=96 title=$rows[1]$rows[2] ></a>" . "</td></tr></div>";
    }
}
